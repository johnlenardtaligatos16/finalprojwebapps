...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a href="index.html"><img src="image/toxzlogo.png" width="64px"></a>
      </li>
      <li class="nav-item">
...
<br>
  ...
  <div class="row">
    <div class="col-sm-8">
      <h1 class="txt-h1">TOXZ TATTOO & <br>BODY PIERCING</h1>
      <div class="txt-p">
    ...
    <div class="col-sm-4">
      <img src="image/sampletattoo.jpg" height="400px" width="300px" alt="" >
    </div>
  </div>
